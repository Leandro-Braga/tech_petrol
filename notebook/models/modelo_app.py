...
from functions.calculation import (calcula_derivada,
                                   ...
                                   decomposicao_sazonal, exibir_periodo_datas,
                                   hyperparametros_prophet, media_movel,
                                   renomeia_colunas, rolmean_rolstd,
                                   split_treino_teste, subtracao_MV_STL,
                                   teste_dickey_fuller,
                                   transformacao_locaritmica, wmape)
from grafo.grafico_gerais import plot_forecast, plot_forecast_prophet, plot_forecast_predict
...
def modelo_prophet_previsao(df_oleo, end_date):
    ...
    # import os
    # print(f'esse é o caminho: {os.getcwd()}')
    # print(os.path.isfile('./model_teste/modelo_treinado.pkl'))
    ...
    if os.path.isfile(caminho_absoluto_modelo):
        ...
        # df_futuro = calcular_e_exibir_diferenca_pkl(predicoes)
